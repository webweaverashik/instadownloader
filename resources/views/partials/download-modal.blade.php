    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 fade-in">
        <div class="text-center">
            ...
            <div class="w-full bg-gray-200 rounded-full h-3 mb-4">
                <div id="progress-bar" class="gradient-bg h-3 rounded-full transition-all duration-300"
                    style="width: 0%"></div>
            </div>
        ...
        <button id="close-modal"
            class="hidden w-full mt-6 gradient-btn text-white py-3 rounded-xl font-semibold hover:opacity-90 transition-all">
