    ...
    <div class="max-w-5xl mx-auto px-4">
        <div class="bg-gray-50 rounded-2xl p-6 md:p-8 fade-in">
            <div class="flex items-center gap-4 mb-6">
                ...
                <a id="post-link" href="#" target="_blank" class="ml-auto theme-text hover:opacity-80 text-sm"><i class="fas fa-external-link-alt mr-1"></i> View Post</a>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-4 flex gap-4 text-sm text-gray-500">
                        <span><i class="fas fa-heart text-red-500 mr-1"></i> <span id="likes-count">0</span> likes</span>
                        <span><i class="fas fa-comment text-blue-500 mr-1"></i> <span id="comments-count">0</span> comments</span>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function selectMedia(index) {
        ...
        document.querySelectorAll('#carousel-thumbnails > div').forEach((thumb, i) => {
            thumb.className = thumb.className.replace(/border-(orange-500|transparent)/, i === index ? 'border-orange-500' : 'border-transparent');
        });
