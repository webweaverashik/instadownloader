                ...
                <div class="relative">
                    <div class="rounded-xl overflow-hidden bg-black aspect-video flex items-center justify-center">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center bg-black/30">
                            <div class="w-16 h-16 bg-white/30 rounded-full flex items-center justify-center backdrop-blur-sm cursor-pointer hover:bg-white/50 transition-all" id="play-preview">
                    ...
                    <span id="duration-badge" class="absolute bottom-3 right-3 bg-black/70 text-white px-3 py-1 rounded-full text-sm">
...
<section class="py-16 theme-light-bg">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            @foreach([
                ['num' => '1', 'title' => 'Copy Video Link', 'desc' => 'Open Instagram, find the video, tap ⋯ and copy link'],
                ['num' => '2', 'title' => 'Paste & Analyze', 'desc' => 'Paste the link above and click Analyze button'],
                ['num' => '3', 'title' => 'Choose & Download', 'desc' => 'Select quality (HD/SD/Audio) and download'],
            ] as $step)
    ...
    <div class="max-w-3xl mx-auto px-4">
        ...
        <div class="space-y-4">
            @foreach([
                ...
                ['q' => 'What video quality options are available?', 'a' => 'We offer HD (1080p), SD (720p), and Audio-only (MP3) options. The available qualities depend on the original video.'],
                ...
                ['q' => 'Is it free to use?', 'a' => 'Yes, completely free with no limits. No registration or login required.'],
                ['q' => 'Can I download from private accounts?', 'a' => 'No, we can only download from public Instagram accounts for privacy reasons.'],
            ] as $faq)
